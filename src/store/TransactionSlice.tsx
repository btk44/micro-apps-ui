...
export const initTransactionStore = createAsyncThunk(transactionSliceName + '/initTransactionStore', async (ownerId: number) => {
      ...
      return Promise
        .all([accountsCall, categoryCall, currencyCall, categoryTypesCall])
        .then(([accountsResponse, categoriesResponse, currencyResponse, categoryTypesResponse]) => {
          ...
          return { accounts: accountsDict, categories: categoriesDict, currencies: currenciesDict, categoryTypes: categoryTypesDict }
        })
})
...
export const transactionSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    builder.addCase(loadTransactions.fulfilled, (state: TransactionsState) => { state.loading = false })
  }
})
